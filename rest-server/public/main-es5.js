...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsSensorTemperatureTemperatureComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div *ngIf=\"(isAuthenticated && user.role=='ADMIN_ROLE')\"  class=\"container\">\n    <div class=\"table-wrapper\">\n      <div class=\"table-title\">\n        <div class=\"row\">\n          <div class=\"col-sm-6\">\n            <h2><b>Lista de datos (Temperatura)</b></h2>\n  \n          </div>\n        </div>\n      </div>\n      <table class=\"table table-striped table-hover\">\n        <thead>\n          <tr>\n            <th>#</th>\n            <th >Temperatura</th>\n            <th>Fecha</th>\n            <th> </th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr *ngFor=\"let tempD of temps | angularPaginator: { currentPage: currentPage, itemsPerPage: 15 }; let i = index\"  >\n            <td>{{i+1}}</td>\n            <td>{{tempD.temp}}</td>\n            <td>{{tempD.date.split('T')[0]+\"   \"+tempD.hour}}</td>\n            <td> </td>\n          </tr>\n<!-- \n          <angular-paginator  (pageChange)=\"currentPage = $event\"></angular-paginator> -->\n          \n        </tbody>\n      </table>\n\n      <angular-paginator   (pageChange)=\"currentPage = $event\"></angular-paginator>\n\n      <!-- <div class=\"clearfix\">\n        <div class=\"hint-text\">Showing <b>5</b> out of <b>25</b> entries</div>\n        <ul class=\"pagination\">\n          <li class=\"page-item disabled\"><a href=\"#\">Previous</a></li>\n          <li class=\"page-item\"><a href=\"#\" class=\"page-link\">1</a></li>\n          <li class=\"page-item\"><a href=\"#\" class=\"page-link\">2</a></li>\n          <li class=\"page-item active\"><a href=\"#\" class=\"page-link\">3</a></li>\n          <li class=\"page-item\"><a href=\"#\" class=\"page-link\">4</a></li>\n          <li class=\"page-item\"><a href=\"#\" class=\"page-link\">5</a></li>\n          <li class=\"page-item\"><a href=\"#\" class=\"page-link\">Next</a></li>\n        </ul>\n      </div> -->\n    </div>\n  </div>\n  \n  ";
    /***/
  },
  ...
  function srcAppComponentsLoginLoginComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n\nbody {\n    font-family: 'Varela Round', sans-serif;\n}\n.modal-login {\t\t\n    color: #636363;\n    width: 350px;\n}\n.modal-login .modal-content {\n    padding: 20px;\n    border-radius: 5px;\n    border: none;\n}\n.modal-login .modal-header {\n    border-bottom: none;   \n    position: relative;\n    justify-content: center;\n}\n.modal-login h4 {\n    text-align: center;\n    font-size: 26px;\n    margin: 30px 0 -15px;\n}\n.modal-login .form-control:focus {\n    border-color: #70c5c0;\n}\n.modal-login .form-control, .modal-login .btn {\n    min-height: 40px;\n    border-radius: 3px; \n}\n.modal-login .close {\n    position: absolute;\n    top: -5px;\n    right: -5px;\n}\n.modal-login .modal-footer {\n    background: #ecf0f1;\n    border-color: #dee4e7;\n    text-align: center;\n    justify-content: center;\n    margin: 0 -20px -20px;\n    border-radius: 5px;\n    font-size: 13px;\n}\n.modal-login .modal-footer a {\n    color: #999;\n}\n.modal-login .avatar {\n    position: absolute;\n    margin: 0 auto;\n    left: 0;\n    right: 0;\n    top: -70px;\n    width: 95px;\n    height: 95px;\n    border-radius: 50%;\n    z-index: 9;\n    background: black;\n    padding: 15px;\n    box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.1);\n}\n.modal-login .avatar img {\n    width: 100%;\n}\n.modal-login.modal-dialog {\n    margin-top: 80px;\n}\n.modal-login .btn {\n    color: #fff;\n    border-radius: 4px;\n    background: #60c7c1;\n    text-decoration: none;\n    transition: all 0.4s;\n    line-height: normal;\n    border: none;\n}\n.modal-login .btn:hover, .modal-login .btn:focus {\n    background: #45aba6;\n    outline: none;\n}\n.trigger-btn {\n    display: inline-block;\n    margin: 100px auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppComponentsNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NavbarComponent = /*#__PURE__*/function () {
      function NavbarComponent(route, router) {
        ...
        this.urlReports = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl, "/report");
      }
    ...
    var CreateUserComponent = /*#__PURE__*/function () {
      ...
      _createClass(CreateUserComponent, [{
        ...
        value: function createUser(userData) {
          ...
          var regexAlfabetoNom = /^[a-zA-Z\ ]+$/gm;
          var regexAlfabetoPat = /^[a-zA-Z\ ]+$/gm;
          var regexAlfabetoMat = /^[a-zA-Z\ ]+$/gm;
          var regexAlfabeNumericoEspacios = /^[0-9A-Za-z\ \,\#\.]+$/gm;
          ...
          var isValid = isValidci && isValidname && isValidlastname && isValidsurname && isValidemail && isValidaddress && isValidcellphone && isValidusername && isValidpassword;
          ...
          if (isValid) {
            this.userService.create(userData).subscribe(function (resp) {
              ...
              if (err.error.err.code == 'ER_DUP_ENTRY') {
                isValidci = false;
                ciBad.innerHTML = "El ci " + userData.ci + " ya se encuentra registrado.";
                ciBad.style.display = "block";
              }
    ...
    var ListUsersComponent = /*#__PURE__*/function () {
      ...
      _createClass(ListUsersComponent, [{
        ...
        value: function updateUserButton(userData) {
          ...
          var username = /^[A-Za-z0-9]+$/gm;
          var password = /^.{7,}$/gm;
          var baseRoot = document.getElementById('userForm2');
          var ciBad = baseRoot.querySelector("#ciBad");
          var nameBad = baseRoot.querySelector("#nameBad");
          var lastnameBad = baseRoot.querySelector("#lastnameBad");
          var surnameBad = baseRoot.querySelector("#surnameBad");
          var emailBad = baseRoot.querySelector("#emailBad");
          var addressBad = baseRoot.querySelector("#addressBad");
          var cellphoneBad = baseRoot.querySelector("#cellphoneBad");
          var usernameBad = baseRoot.querySelector("#usernameBad");
          var passwordBad = baseRoot.querySelector("#passwordBad");
          var isValidci = false;
          var isValidname = false;
          var isValidlastname = false;
          var isValidsurname = false;
